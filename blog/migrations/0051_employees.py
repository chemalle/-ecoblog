# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2018-04-11 13:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_carteira', models.DateField()),
                ...
                ('Estado_Civil', models.CharField(choices=[('Casado', 'Casado'), ('Solteiro', 'Solteiro'), ('Divorciado', 'Divorciado'), ('Desquitado', 'Desquitado'), ('Viúvo', 'Viúvo')], help_text='Estado Civil colaborador', max_length=20)),
                ('Grau_Instrucao', models.CharField(choices=[('Analfabeto', 'Analfabeto'), ('Ensino Fundamental Incompleto', 'Ensino Fundamental Incompleto'), ('Ensino Fundamental Completo', 'Ensino Fundamental Completo'), ('Ensino Médio Incompleto', 'Ensino Médio Incompleto'), ('Ensino Médio Completo', 'Ensino Médio Completo'), ('Superior completo (ou Graduação)', 'Superior completo (ou Graduação)'), ('Pós-Graduação', 'Pós-Graduação'), ('Mestrado', 'Mestrado'), ('Doutorado', 'Doutorado'), ('PHD', 'PHD')], help_text='Escolaridade do colaborador', max_length=20)),
                ...
                ('Defeitos', models.CharField(help_text='Caso aplicavel', max_length=12)),
                ...
                ('Data_Chegada_Brasil', models.DateField(blank=True)),
                ('N_Carteira_Mod_19', models.CharField(blank=True, help_text='No caso de estrageiro, informar o numero', max_length=50)),
                ('Validade_Cart_Identidade_Estrangeiro', models.DateField(blank=True)),
                ...
                ('Validade_Carteira_Trabalho', models.DateField(blank=True)),
                ('Data_Admissao', models.DateField()),
                ('Data_Opção_FGTS', models.DateField()),
                ('Forma_Pagamento', models.CharField(help_text='Mensal ou por hora?', max_length=50)),
                ('Cargo_Atual', models.CharField(help_text='Cargo do colaborador', max_length=50)),
                ('Salario', models.FloatField()),
                ('Tipo_Salario', models.CharField(help_text='Mensalista ou por horista?', max_length=50)),
